...
typedef int		(*t_array_match)(const void *elem, const void *param);
...
t_array			*array_replace_at(t_array *a, size_t i, const void *e,
		void *old);
...
void			*array_find_from(t_array set, size_t n, t_array_match match,
		const void *param);
void			*array_find(t_array set, t_array_match match,
		const void *param);
